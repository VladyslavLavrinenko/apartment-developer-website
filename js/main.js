...
$('input[name="user_phone"]').mask("+38 (099) 999-99-99");
    ...
    let myRange = document.getElementById('myRange');
      ...
      if(myRange.value == 6){
      myPhoto.src = "img/prj/01.01.jpg"
      } else if(myRange.value == 5){
        myPhoto.src = 'img/prj/02.02.jpg'
	  }
	  	else if(myRange.value == 4){
        myPhoto.src = 'img/prj/03.03.jpg'
      } else if(myRange.value == 3){
        myPhoto.src = 'img/prj/04.04.jpg'
      } else if(myRange.value == 2){
      	myPhoto.src = 'img/prj/05.05.jpg'
      } else if(myRange.value == 1){
      	myPhoto.src = 'img/prj/06.06.jpg'
	  }
	  else if(myRange.value == 0){
		myPhoto.src = 'img/prj/07.07.jpg'
	}
